    ...
    private static final String QUESTION_TABLE_INSERT =
            "INSERT INTO " + QuestionList.TABLE_NAME +
                    ...
                    "( '6', " +
                        ...
                        "), "+
                    "( '7', " +
                        " 'The bandwidth is ______ kHz in the given circuit.', " +
                        " '3.54', " +
                        " '0', " +
                        " '4', " +
                        "), "+
                    ...
                    "( '11', " +
                        ...
                        "), "+
                    "( '12', " +
                        " 'The phase angle in the given circuit equals___ degrees.', " +
                        " '36.87', " +
                        " '1', " +
                        " '4', " +
                        "), "+
                    ...
                    "( '14', " +
                        ...
                        "), "+
                    "( '15', " +
                        " 'What has the voltage across the resistor decayed to by the end of the pulse in the given circuit?(Volts)', " +
                        " '0.75', " +
                        " '0', " +
                        " '4', " +
                        "), "+
                    ...
                    "), "+
                    "( '30', " +
                    " '_______ measure's 'g-force' and can be easily found in any smart phone', " +
                    " 'accelerometer', " +
                    " '0', " +
                    " '4', " +
                    ");";
